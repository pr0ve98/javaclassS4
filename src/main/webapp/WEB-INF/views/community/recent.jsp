										...
										<div style="color:#b2bdce; font-size:12px;" class="mt-2">
											...
											<c:if test="${sMid != null}">
												<div class="replymenu">
													...
													<c:if test="${sMid == parentReply.replyMid}"><span class="mr-2" onclick="replyEditPopup(${parentReply.replyIdx}, '${fn:replace(parentReply.replyContent, newLine, '')}')">수정</span></c:if>
