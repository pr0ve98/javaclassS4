	...
	$(document).ready(function() {
		...
		function rootData() {
			...
			$.ajax({
				...
				type : "post",
				data : {page : ${page}+totPage, part : 'report'},
		...
		<div class="community">
			...
			<div style="width:100%;">
				<div class="c-buttons">
					...
					<span class="c-button c-button-active" onclick="location.href='${ctp}/news/newsReport';">취재</span>
					<span class="c-button" onclick="location.href='${ctp}/news/newsSale';">예판</span>
				</div>
				<c:if test="${sLevel == 1}">
					<div class="cm-box">
						<div style="display:flex; align-items: center; justify-content: center;">
							<img src="${ctp}/member/${sMemImg}" alt="프로필" class="text-pic">
							<div class="text-input" onclick="location.href='${ctp}/news/newsInput?part=취재';">작성할 뉴스가 있으신가요?</div>
						</div>
					</div>
				</c:if>
