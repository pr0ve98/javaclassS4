	    ...
	    <div class="gameviewContent">
	    	<div class="gvc-width">
			    ...
			    <c:if test="${posiBest != null}">
		    		<div class="cm-box mt-3 mb-3" style="cursor: pointer;" onclick="gameViewCommunityView(${posiBest.cmIdx})">
						<div style="display:flex;justify-content: space-between; align-items: center;">
							<div>
				...
				<c:if test="${negaBest != null}">
		    		<div class="cm-box mt-3 mb-3" style="cursor: pointer;" onclick="gameViewCommunityView(${negaBest.cmIdx})">
						<div style="display:flex;justify-content: space-between; align-items: center;">
							<div>
				...
				<c:if test="${myReview != null}">
		    		<div class="cm-box mt-3 mb-3" style="cursor: pointer;" onclick="gameViewCommunityView(${myReview.cmIdx})">
						<div style="display:flex;justify-content: space-between; align-items: center;">
							<div>
				...
				<hr/>
		    		...
		    		<c:forEach var="ilgi" items="${ilgilist}">
						<div class="cm-box" style="cursor: pointer;" onclick="gameViewCommunityView(${ilgi.cmIdx})">
		    		...
		    		<c:forEach var="info" items="${infolist}">
						<div class="cm-box" style="cursor: pointer;" onclick="gameViewCommunityView(${info.cmIdx})">
							<div style="display:flex;justify-content: space-between;">
								<div style="display:flex; align-items:center;">
