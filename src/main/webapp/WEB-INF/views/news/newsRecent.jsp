...
<main>
	...
	<div class="container">
		...
		<div class="community">
			...
			<div style="width:100%;">
				<div class="c-buttons">
					<span class="c-button c-button-active" onclick="location.href='${ctp}/news/newsRecent';">뉴스</span>
				...
				<c:if test="${sLevel == 1}">
					<div class="cm-box">
						<div style="display:flex; align-items: center; justify-content: center;">
							...
							<div class="text-input" onclick="location.href='${ctp}/news/newsInput';">작성할 뉴스가 있으신가요?</div>
						</div>
					</div>
				</c:if>
