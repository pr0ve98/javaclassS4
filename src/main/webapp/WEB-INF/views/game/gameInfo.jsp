	...
	$(document).ready(function() {
		...
		function rootData() {
			...
			$.ajax({
				...
				type : "post",
				data : {page : ${page}+totPage, part : '소식/정보', gameIdx:gameIdx},
...
<main style="padding: 0 20px 70px;">
	...
	<div class="container">
	    ...
	    <hr/>
	    <c:if test="${fn:length(cmVOS) != 0}"><div class="editplz-button mt-2" style="background-color:#00c72299;" onclick="showPopupWrite()">소식/정보 작성</div></c:if>
