...
<nav>
	<div id="hambuger-menu">
		...
		<div class="header darkmode">
			...
			<img src="${ctp}/resources/images/logo.png" style="cursor:pointer;" alt="로고" height="70px" class="p-2 ml-4" onclick="location.href='${ctp}/'">
			<div class="right-menu">
			<c:if test="${sMid != null}">
					<i id="alramBtn" class="fa-solid fa-bell fa-lg" style="cursor:pointer;position: relative;" onclick="mtoggleAlramMenu()">
	...
	<div id="pc-menu" class="darkmode pt-1 pb-1">
		<div class="container p-menu">
			<div>
				<img src="${ctp}/resources/images/logo.png" style="cursor:pointer;" alt="로고" height="80px" class="p-2 ml-2" onclick="location.href='${ctp}/'">
